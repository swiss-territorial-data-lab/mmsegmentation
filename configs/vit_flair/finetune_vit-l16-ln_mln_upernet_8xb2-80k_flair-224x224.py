...
# load_from = '/mnt/Data2/sli/mmsegmentation/work_dirs/no_photometric/linprobe_2e-5_dist/iter_20000.pth'
# load_from = '/mnt/Data2/sli/mmsegmentation/work_dirs/no_photometric/finetune_2e-6_dist/iter_40000.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        # init_cfg = dict(type='Pretrained', checkpoint='/mnt/Data2/sli/mmsegmentation/work_dirs/vit_init_linprobe/iter_10000.pth')
        ),
    neck=dict(
        type='MultiLevelNeck',
